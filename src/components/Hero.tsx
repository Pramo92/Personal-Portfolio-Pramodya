        ...
        <div className="flex flex-wrap items-center justify-between">
            ...
            transition={{duration:1, delay :1.2}} className="w-full lg:w-1/3 flex justify-center lg:justify-end items-center pt-20 pl-6 pr-10 pb-12">
                <div className="relative">
                    ...
                    <img src={profilePic} alt="Pramodya Madhubhashini" className="relative w-full h-auto max-h-[360px] object-cover rounded-lg shadow-lg border-4 border-cyan-500 z-10" />
